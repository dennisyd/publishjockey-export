...
\setCJKfallbackfamilyfont{zhsong}{Noto Sans CJK TC}
\setCJKfallbackfamilyfont{zhhei}{Noto Sans CJK TC}
\setCJKfallbackfamilyfont{zhkai}{Noto Sans CJK TC}
\setCJKfallbackfamilyfont{zhfs}{Noto Sans CJK TC}
...
$if(CJKchinese)$
\XeCJKsetup{
  CJKchinesespacing=true,
  CJKchinese=true
}
$endif$

% Enhanced Chinese text flow controls
$if(CJKtextwidth)$
\XeCJKsetup{
  CJKtextwidth=true,
  CJKlinebreak=true,
