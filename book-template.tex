...
% --- Font setup for RTL languages ---
$if(mainfont)$
\setmainfont{$mainfont$}
$endif$

% --- Additional font features for better rendering ---
...
\ifxetex
  ...
  % NOTE: For best results with RTL languages (Arabic, Hebrew, Yiddish),
  % use pure language content only. Mixed content may not display correctly.
\fi
$endif$
...
% --- Enhanced hyphenation and justification ---
$if(babel-lang)$
...
% Enhanced line breaking and justification
\tolerance=2000
\pretolerance=100
\hyphenpenalty=50
\exhyphenpenalty=50
