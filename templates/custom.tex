...
$if(polyglossia)$
\ifxetex
  % Load polyglossia for Hindi language support
  \usepackage{polyglossia}
  \setdefaultlanguage{english}
  \setotherlanguage{hindi}
  
  % Set up Hindi font with proper script support
  ...
  % Set up fallback font for English text in Hindi documents
  % This prevents rectangles (missing character boxes) for English text
  \newfontfamily\englishfallbackfont{Liberation Serif}[
    Script=Latin,
    Ligatures=TeX,
    Scale=MatchLowercase,
    Language=English
  ...
  % Set Hindi as the main language for the document
  \setmainlanguage{hindi}
  
  % Configure font fallback for mixed script content
  % When Noto Sans Devanagari can't render a character, fall back to Liberation Serif
  \newfontfamily\mixedscriptfont{Noto Sans Devanagari}[
    Script=Devanagari,
    Ligatures=TeX,
    Scale=MatchLowercase,
    Language=Hindi,
    FontFallback={Liberation Serif}
  ]
  
  % Configure Unicode-aware PDF bookmarks
  ...
  % Use the mixed script font for the main document
  \setmainfont{\mixedscriptfont}
\fi
$endif$
