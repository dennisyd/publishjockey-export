...
% Enhanced microtype package for professional typography (XeLaTeX compatible)
...
\ifxetex
  ...
  % Russian-specific microtype settings for tighter spacing
  \IfFileExists{microtype.sty}{%
    \microtypesetup{
      protrusion=true,
      expansion=true,
      ...
      kerning=true,
      spacing=true,
      factor=1200,  % Slightly more aggressive expansion for Russian
      stretch=15,   % More stretch tolerance for Cyrillic
      shrink=15    % More shrink tolerance for Cyrillic
    }
  }{}
\fi
