...
% Multi-script typography optimization
\ifxetex
  % Multi-language support with optimized spacing
  \usepackage{polyglossia}
  ...
  % Greek-specific font configuration (using available fonts)
  \newfontfamily\greekfont[Script=Greek]{Liberation Serif}
  \newfontfamily\greekfontsf[Script=Greek]{Liberation Sans}
  \newfontfamily\greekfonttt[Script=Greek]{Liberation Mono}
  
  % Script-specific spacing optimizations (microtype-free)
  % Using core LaTeX spacing controls for tighter text
\fi
