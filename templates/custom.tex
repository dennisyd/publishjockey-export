...
\ifxetex
  ...
  % Russian-specific microtype settings for tighter spacing (XeLaTeX compatible)
  \IfFileExists{microtype.sty}{%
    \microtypesetup{
      protrusion=true,
      expansion=false,  % XeLaTeX doesn't support expansion
      tracking=false,   % XeLaTeX doesn't support tracking
      kerning=true,
      spacing=true
    }
  }{}
