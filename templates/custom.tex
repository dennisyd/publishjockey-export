...
% --- Hindi font setup for mixed script support ---
$if(lang.hi)$
\ifxetex
  % Set up Noto Sans Devanagari with fallback for English text
  \setmainfont{Noto Sans Devanagari}[
    Script=Devanagari,
    Ligatures=TeX,
    Scale=MatchLowercase
  ]
  % Add fallback font for English text in Hindi documents
