...
\ifxetex
  ...
  % Define Hindi font family for Devanagari script
  ...
  % Configure polyglossia to use the Hindi font for Hindi text
  \setotherlanguages{english}
  \setdefaultlanguage[numerals=Devanagari]{hindi}
  
  % Tell polyglossia to use our custom font for Hindi
