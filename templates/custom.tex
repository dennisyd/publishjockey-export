...
\else % if luatex or xelatex
  ...
  % ==== Safe no-ops for optional script transition macros ====
  \makeatletter
  \@ifundefined{setTransitionsForCyrillic}{%
    \providecommand{\setTransitionsForCyrillic}[2]{}%
  }{}
  \@ifundefined{setTransitionsForGreek}{%
    \providecommand{\setTransitionsForGreek}[2]{}%
  }{}
  \@ifundefined{setTransitionsForLatin}{%
    \providecommand{\setTransitionsForLatin}[2]{}%
  }{}
  \@ifundefined{setTransitionsForDevanagari}{%
    \providecommand{\setTransitionsForDevanagari}[2]{}%
  }{}
  \@ifundefined{setTransitionsForTamil}{%
    \providecommand{\setTransitionsForTamil}[2]{}%
  }{}
  \@ifundefined{setTransitionsForBengali}{%
    \providecommand{\setTransitionsForBengali}[2]{}%
  }{}
  \@ifundefined{setTransitionsForGurmukhi}{%
    \providecommand{\setTransitionsForGurmukhi}[2]{}%
  }{}
  \@ifundefined{setTransitionsForArabic}{%
    \providecommand{\setTransitionsForArabic}[2]{}%
  }{}
  \@ifundefined{setTransitionsForHebrew}{%
    \providecommand{\setTransitionsForHebrew}[2]{}%
  }{}
  \makeatother
  % ===========================================================
...
% --- MODULAR MULTI-SCRIPT FONT SETUP (FIXED) ---
% Clean, reliable font configuration for all supported scripts
\ifxetex
  % Load ucharclasses for automatic script switching
  \usepackage{ucharclasses}
  
  % English/Latin font for transitions (default for most documents)
  ...
  % Font transitions - ONLY if ucharclasses loaded successfully
  \setTransitionsForLatin{\englishfont}{}
  \setTransitionsForCyrillic{\cyrillicfont}{}
  \setTransitionsForGreek{\greekfont}{}
  \setTransitionsForDevanagari{\devanagarifont}{}
  \setTransitionsForTamil{\tamilfont}{}
  \setTransitionsForBengali{\bengalifont}{}
  \setTransitionsForGurmukhi{\gurmukhifont}{}
  \setTransitionsForArabic{\arabicfont}{}
