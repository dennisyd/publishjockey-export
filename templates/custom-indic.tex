...
\ifxetex
  ...
  % Set Indic script as the main font based on document language
  ...
  $else$
  % Default to Noto Sans Tamil (can be overridden by script-switching)
  ...
  % Define fonts for different Indic scripts
