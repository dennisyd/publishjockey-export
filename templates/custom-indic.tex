...
\ifxetex
  ...
  % Multiple definitions to support all available Devanagari fonts
  \IfFontExistsTF{Noto Serif Devanagari}{
    ...
    \IfFontExistsTF{Noto Sans Devanagari UI}{
      \newfontfamily\devanagarifont{Noto Sans Devanagari UI}[
        Script=Devanagari,
        Renderer=HarfBuzz,
        Ligatures=TeX,
        Language=Hindi,
  ...
  % Tamil fonts
  % Multiple definitions to support all available Tamil fonts
  \IfFontExistsTF{Noto Serif Tamil}{
    ...
    \IfFontExistsTF{Noto Sans Tamil UI}{
      \newfontfamily\tamilfont{Noto Sans Tamil UI}[
        Script=Tamil,
        Renderer=HarfBuzz,
        Ligatures=TeX,
        Language=Tamil,
  ...
  % Multiple definitions to support all available Bengali fonts
  \IfFontExistsTF{Noto Serif Bengali}{
    ...
    \IfFontExistsTF{Noto Sans Bengali UI}{
      \newfontfamily\bengalifont{Noto Sans Bengali UI}[
        Script=Bengali,
        Renderer=HarfBuzz,
        Ligatures=TeX,
        Language=Bengali,
  ...
  % Multiple definitions to support all available Gurmukhi fonts
  \IfFontExistsTF{Noto Serif Gurmukhi}{
    ...
    \IfFontExistsTF{Noto Sans Gurmukhi UI}{
      \newfontfamily\gurmukhifont{Noto Sans Gurmukhi UI}[
        Script=Gurmukhi,
        Renderer=HarfBuzz,
        Ligatures=TeX,
        Language=Punjabi,
      ...
      \newfontfamily\gurmukhifont{FreeSerif}[
        Script=Gurmukhi,
        Renderer=HarfBuzz,
        Ligatures=TeX,
        Language=Punjabi,
