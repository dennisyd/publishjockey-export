...
% ---------- Pre-load packages that must come before bidi ----------
\usepackage{caption}
\usepackage{graphicx}

% ---------- Geometry (handled via Pandoc include-in-header) ----------
% Note: Geometry package is loaded via Pandoc's include-in-header mechanism
...
% ---------- Graphics support ----------
% Note: graphicx loaded earlier to avoid bidi conflicts
\makeatletter
