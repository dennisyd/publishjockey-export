...
\ifxetex
  ...
  % Automatic script switching with balanced groups
...
% Note: bidi loading moved to just before \begin{document} to avoid Pandoc conflicts

\begin{document}

% Load bidi package as the very last package to avoid conflicts
\ifxetex
